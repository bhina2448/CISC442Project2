...
#gets the disparity using corner detection and SSD
...
def SSDDispCorner(template, templateypos,templatexpos,rightCorners, rightImg,templateW,templateH,searchRange):
